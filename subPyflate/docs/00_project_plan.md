...
**Role:** Benchmark #2 for the HWSW project (companion to `subRay/`).
**Source of truth:** Markdown files under `subPyflate/docs/`.
**Evidence policy:**
...
- Never modify anything in `subRay/`.
- Never modify anything in `subPyflate/original/`.
...
- Every prompt actually used is recorded in `subPyflate/prompts/prompts.md`.
