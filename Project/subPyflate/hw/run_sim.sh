...
# Project/subPyflate/hw/results/ and appends a summary to SIMULATION_RESULTS.txt.
#
# Usage:
#   bash Project/subPyflate/hw/run_sim.sh                # all three testbenches
#   bash Project/subPyflate/hw/run_sim.sh tb_huff_lut
set -euo pipefail
...
SUMMARY="$RESULTS_DIR/SIMULATION_RESULTS.txt"
{
    ...
    echo "    claimed; see Project/subPyflate/docs/13_hardware_performance.md for"
