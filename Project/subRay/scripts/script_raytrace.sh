...
Usage:
  ...
  bash Project/subRay/scripts/script_raytrace.sh profile-suite
...
run_baseline_mode() {
  ...
  print_step "Running existing baseline workflow: Project/subRay/scripts/run_baseline.sh"
  bash "$script"
}
...
run_optimize_mode() {
  ...
  print_step "Running final optimized benchmark from Project/subRay/optimized/final/"
  echo "Command: ${cmd[*]}"
  "${cmd[@]}"
...
run_attempt1_mode() {
  ...
  print_step "Running existing attempt1 workflow: Project/subRay/scripts/run_attempt1.sh"
  bash "$script"
}
...
run_profile_mode() {
  ...
  print_step "Running existing profiling workflow: Project/subRay/scripts/run_profile.sh"
