...
- `Project/subRay/profiling/final_perf_stat.txt`
- `Project/subRay/profiling/flamegraph_pyspy_final.svg`
...
- `Project/subRay/profiling/flamegraph_pyspy_final.svg`
- Captured directly from `Project/subRay/optimized/final/run_benchmark.py` (same implementation as Attempt 1).
- Embedded command metadata shows:
	- `py-spy record --rate 100 --native`
	- `python3-dbg /root/homewroksbothsofthard/Project/subRay/optimized/final/run_benchmark.py`
	- `--width=64 --height=64`
	- no `--fast`
