...
Testbenches (`Project/subRay/hw/tb/`):
...
Simulation artifacts (`Project/subRay/hw/results/`):
...
RTL and testbench are provided under `Project/subRay/hw/` from this step onward.
