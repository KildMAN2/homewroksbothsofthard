...
- Existing profiling artifacts were left untouched in [Project/subRay/profiling](Project/subRay/profiling).
- The prior flame graph was preserved under a descriptive name: [Project/subRay/profiling/flamegraph_original.svg](Project/subRay/profiling/flamegraph_original.svg).
...
- Therefore [Project/subRay/profiling/flamegraph_pyspy.svg](Project/subRay/profiling/flamegraph_pyspy.svg) was not generated in this step.
...
- Output filename: [Project/subRay/profiling/flamegraph_pyspy.svg](Project/subRay/profiling/flamegraph_pyspy.svg)
...
- Preserved prior flame graph copy exists: [Project/subRay/profiling/flamegraph_original.svg](Project/subRay/profiling/flamegraph_original.svg).
- Supplemental perf stat output exists: [Project/subRay/profiling/perf_stat.txt](Project/subRay/profiling/perf_stat.txt).
- Supplemental perf stat benchmark stdout exists: [Project/subRay/profiling/perf_stat_stdout.txt](Project/subRay/profiling/perf_stat_stdout.txt).
...
Previous bottleneck conclusions remain unchanged for now. A re-check should be done after py-spy is installed and [Project/subRay/profiling/flamegraph_pyspy.svg](Project/subRay/profiling/flamegraph_pyspy.svg) is generated.
...
- [Project/subRay/profiling/flamegraph_pyspy_baseline.svg](Project/subRay/profiling/flamegraph_pyspy_baseline.svg)
- [Project/subRay/profiling/flamegraph_pyspy_final.svg](Project/subRay/profiling/flamegraph_pyspy_final.svg)

Embedded command metadata read directly from SVG titles:

- `flamegraph_pyspy_baseline.svg`
	- `py-spy record --rate 100 --native`
	- `--output /root/homewroksbothsofthard/Project/subRay/profiling/flamegraph_pyspy_baseline.svg`
...
- `flamegraph_pyspy_final.svg`
	- `py-spy record --rate 100 --native`
	- `--output /root/homewroksbothsofthard/Project/subRay/profiling/flamegraph_pyspy_final.svg`
	- `-- python3-dbg /root/homewroksbothsofthard/Project/subRay/optimized/final/run_benchmark.py --width=64 --height=64`
