...
**Root working directory:** `Project/subRay/`  
**Created:** 2026-09-13  
...
- Preserve the original benchmark unchanged under `Project/subRay/original/`.
- Do not modify benchmark code before baseline profiling unless a documented change is strictly required to run it.
- Put all modified implementations under `Project/subRay/optimized/`.
