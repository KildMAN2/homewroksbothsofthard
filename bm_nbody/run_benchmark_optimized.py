...
Final optimized pure-Python copy (V1-V4 safe optimizations):
- Scalarized local velocity/position updates (V1).
- Unrolled fixed 10 body-pair interaction blocks (V2).
- Sqrt-based inverse-cube distance expression (V3).
- Precomputed invariant dt*mass constants per advance() call (V4).
