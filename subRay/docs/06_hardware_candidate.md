...
- subRay/docs/02_profiling_and_bottlenecks.md
- subRay/docs/04_final_software_result.md
- subRay/docs/05_before_after_profiling.md
- Measured hotspot evidence in profiling text reports:
  - subRay/profiling/perf_report.txt
  - subRay/profiling/perf_report_supplemental.txt
