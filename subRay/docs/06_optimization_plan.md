...
2. **Original implementation.** The code represents nearly all geometry using `Vector`, `Point`, and `Ray` objects, with many method calls such as `dot`, `cross`, `scale`, `normalized`, `reflectThrough`, `pointAtTime`, `intersectionTime`, and `colourAt`. The hottest source regions that trigger this style are [subRay/original/bm_raytrace/run_benchmark.py](c:/Users/Sarim/homewroksbothsofthard/subRay/original/bm_raytrace/run_benchmark.py#L245), [subRay/original/bm_raytrace/run_benchmark.py](c:/Users/Sarim/homewroksbothsofthard/subRay/original/bm_raytrace/run_benchmark.py#L266), [subRay/original/bm_raytrace/run_benchmark.py](c:/Users/Sarim/homewroksbothsofthard/subRay/original/bm_raytrace/run_benchmark.py#L315), and the vector helpers beginning at [subRay/original/bm_raytrace/run_benchmark.py](c:/Users/Sarim/homewroksbothsofthard/subRay/original/bm_raytrace/run_benchmark.py#L22).
...
1. **Bottleneck being addressed.** Frame creation, tuple access, allocation/deallocation, and interpreter overhead associated with building and scanning `intersections = [(o, o.intersectionTime(ray), s) for (o, s) in self.objects]` in `Scene.rayColour` at [subRay/original/bm_raytrace/run_benchmark.py](c:/Users/Sarim/homewroksbothsofthard/subRay/original/bm_raytrace/run_benchmark.py#L270).
2. **Original implementation.** For every ray, the code allocates a list of tuples for every object and then performs a second pass in `firstIntersection` at [subRay/original/bm_raytrace/run_benchmark.py](c:/Users/Sarim/homewroksbothsofthard/subRay/original/bm_raytrace/run_benchmark.py#L213).
...
2. **Original implementation.** The hot loops repeatedly resolve attributes like `canvas.width`, `canvas.height`, `self.objects`, `self.lightPoints`, method references such as `scene.rayColour`, and vector operations through normal Python attribute lookup in [subRay/original/bm_raytrace/run_benchmark.py](c:/Users/Sarim/homewroksbothsofthard/subRay/original/bm_raytrace/run_benchmark.py#L245), [subRay/original/bm_raytrace/run_benchmark.py](c:/Users/Sarim/homewroksbothsofthard/subRay/original/bm_raytrace/run_benchmark.py#L266), and [subRay/original/bm_raytrace/run_benchmark.py](c:/Users/Sarim/homewroksbothsofthard/subRay/original/bm_raytrace/run_benchmark.py#L315).
...
1. **Bottleneck being addressed.** Repeated per-pixel integer conversion, clamping, and indexed byte writes in `Canvas.plot` and the blue-channel initialization loop in `Canvas.__init__` at [subRay/original/bm_raytrace/run_benchmark.py](c:/Users/Sarim/homewroksbothsofthard/subRay/original/bm_raytrace/run_benchmark.py#L193) and [subRay/original/bm_raytrace/run_benchmark.py](c:/Users/Sarim/homewroksbothsofthard/subRay/original/bm_raytrace/run_benchmark.py#L200).
...
1. **Bottleneck being addressed.** Repeated ray construction, repeated visibility checks over all objects, and repeated shading helper work in `Scene.rayColour`, `_lightIsVisible`, `visibleLights`, and `SimpleSurface.colourAt` at [subRay/original/bm_raytrace/run_benchmark.py](c:/Users/Sarim/homewroksbothsofthard/subRay/original/bm_raytrace/run_benchmark.py#L266), [subRay/original/bm_raytrace/run_benchmark.py](c:/Users/Sarim/homewroksbothsofthard/subRay/original/bm_raytrace/run_benchmark.py#L283), [subRay/original/bm_raytrace/run_benchmark.py](c:/Users/Sarim/homewroksbothsofthard/subRay/original/bm_raytrace/run_benchmark.py#L290), and [subRay/original/bm_raytrace/run_benchmark.py](c:/Users/Sarim/homewroksbothsofthard/subRay/original/bm_raytrace/run_benchmark.py#L315).
