...
run_benchmark "V1 scalar" "$SUBNBODY/software/run_benchmark_v1_scalar.py" "v1_scalar.json"
run_benchmark "V2 unroll" "$SUBNBODY/software/run_benchmark_v2_unroll.py" "v2_unroll.json"
run_benchmark "V3 sqrt" "$SUBNBODY/software/run_benchmark_v3_sqrt.py" "v3_sqrt.json"
run_benchmark "V4 precompute" "$SUBNBODY/software/run_benchmark_v4_precompute.py" "v4_precompute.json"
run_benchmark "final optimized" "$SUBNBODY/software/run_benchmark_optimized.py" "optimized.json"
